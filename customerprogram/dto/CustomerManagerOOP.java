/*
실습
1. CustomerManager 프로그램에 OOP를 적용하여 프로그램을 리팩토링해 주세요.
    CustomerManager 프로그램에서 Customer 라는 객체를 클래스로 선언한 후에 사용하여
    고객의 정보를 담는 객체를 사용할 수 있게 만들어 주세요.

2. Customer 클래스를 생성한 이후 코드가 정상적으로 동작하게 리팩터링을 해 주세요.

hint. 고객 정보가 저장되는 배열에 Customer 객체를 넣으면 됨.
*/
