 ...
 * import java.util.Scanner;
 * 
 * public class CustomerManagerOOPEx {
 ...
 * if (serch.equals("이름")) {
 * System.out.println("찾으시는 이름을 입력해 주세요.");
 * sInfo = scanner.next();
 * for (int i = 0; i <= index; i++) {
 * if (sInfo.equals(customers[i].getName())) {
 * printCustomerData(i);
 * found = true;
 * }
 * }
 ...
 * }
 * 
 * } else if (serch.equals("성별")) {
 * System.out.println("찾으시는 성별을 입력해 주세요.");
 * sInfo = scanner.next();
 ...
 * }
 * 
 * } else if (serch.equals("이메일")) {
 * System.out.println("찾으시는 이메일을 입력해 주세요.");
 * sInfo = scanner.next();
 * for (int i = 0; i <= count; i++) {
 * if (sInfo.equals(customers[i].getEmail())) {
 * printCustomerData(i);
 * found = true;
 * }
 * }
 ...
 * System.out.println("입력하신 정보가 없습니다.");
 * }
 * } else if (serch.equals("출생년도")) {
 * iInfo = scanner.nextInt();
 * for (int i = 0; i <= count; i++) {
 * System.out.println("찾으시는 출생년도를 입력해 주세요.");
 ...
 * System.out.println("입력하신 정보가 없습니다.");
 * }
 * } else if (serch.equals("등급")) {
 * sInfo = scanner.next();
 * for (int i = 0; i <= count; i++) {
 * System.out.println("찾으시는 등급을 입력해 주세요.");
 * if (sInfo.equals(customers[i].getRank())) {
 * printCustomerData(i);
 * found = true;
 * }
 * }
 ...
 * 
 * Customer c = new Customer(name, gender, email, birthYear, rank);
 * customers[count] = c;
 * 
 * // 고객 정보 저장
